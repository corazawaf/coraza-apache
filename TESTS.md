...
The integration test suite (`test.sh`) runs **212 tests** against a Docker
...
# Full suite (212 tests, event MPM)
...
| `--container=NAME` | Enables audit/debug log tests via `docker exec` and the crash sweep (+76 tests) |
